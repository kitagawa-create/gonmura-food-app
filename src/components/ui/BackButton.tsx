...
export function BackButton({
  ...
  const base =
    size === "sm"
      ? "inline-flex items-center justify-center gap-1 min-w-[36px] min-h-[36px] px-2 rounded-full text-xs font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
